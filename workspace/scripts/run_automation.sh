#!/bin/bash
# ==============================================================================
# 🤖 Script de Lancement - Pipeline de Réarrangement Autonome avec Tiago
# ==============================================================================
#
# Ce script facilite le lancement du pipeline d'automatisation.
#
# Usage:
#   ./run_automation.sh                  # Pipeline complet
#   ./run_automation.sh capture          # Capture uniquement
#   ./run_automation.sh pipeline         # Pipeline IA uniquement
#   ./run_automation.sh command          # Commande robot uniquement
#   ./run_automation.sh --no-wait        # Sans attendre Gazebo
#
# ==============================================================================
...
print_header "Pipeline de Réarrangement Autonome avec Tiago"
...
# Sourcer l'environnement ROS si disponible
...
print_header "Démarrage du Pipeline"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    print_header "Pipeline Terminé avec des Erreurs"
